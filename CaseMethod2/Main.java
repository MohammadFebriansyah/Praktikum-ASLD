            ...
            switch (pilihan) {
                ...
                case 3:
                    ...
                    if (pasienDilayani == null) {
                        ...
                        int jam = sc.nextInt();
                        sc.nextLine(); 
                        TransaksiLayanan transaksi = new TransaksiLayanan(pasienDilayani, dokter, jam);
                ...
                case 4:
                    int jumlah = antrian.hitungAntrian();
                    System.out.println(">> Sisa pasien dalam antrian: " + jumlah);
                    break;
